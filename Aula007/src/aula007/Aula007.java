...
public class Aula007 {
    public static void main(String[] args) {
        Lutador l[] = new Lutador[6]; //Instanciando um vetor de Lutador com 6 posições
        
        //Instanciando objetos com base no seu indice do vetor
        l[0] = new Lutador("Pretty Boy", "Franca",
                                    31, 1.75f, 68.9f, 11, 3, 1);
        
        l[1] = new Lutador("Putscript", "Brasileiro",
